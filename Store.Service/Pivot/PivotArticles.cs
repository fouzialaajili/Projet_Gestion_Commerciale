...
namespace Store.Service.Pivot
{
    public class PivotArticle
    {
        ...
        public  PivotDossiers  ArticleSociete { get; set; }
        public long ArticleDepotId { get; set; }
        public  PivotDepot ArticleDepot { get; set; }
        public long ArticleCategorieId { get; set; }
        public  PivotCategorie ArticleCategorie { get; set; }
        public long ArticleUniteId { get; set; }
        public  PivotUnite ArticleUnite { get; set; }
        public long ArticleMarqueId { get; set; }
        public  PivotMarque ArticleMarque { get; set; }

        public  ICollection<PivotFournisseurArticle> ArticleFournisseurArticle { get; set; }
        public ICollection<PivotMouvementStock> ArticleMouvementStock { get; set; }
        public  ICollection<PivotNomenclature> ArticleNomenclature { get; set; }
        public  ICollection<PivotArticlesPrix> ArticleArticlesPrix { get; set; }
        public ICollection<PivotDocumentCommercialDetail> ArticleDocumentCommercialDetail { get; set; }
        public  ICollection<PivotArticlesKit> ArticleArticlesKit { get; set; }
        public  ICollection<PivotArticlesKit> ArticleArticlesKit1 { get; set; }
