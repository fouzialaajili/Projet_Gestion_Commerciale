...
{
    public class PivotDocumentCommercial
    {
      ...
      public long  DocumentCommercialSocieteId { get; set; }
        public PivotDossiers DocumentCommercialSociete { get; set; }

        public  ICollection<PivotMouvementStock> DocumentCommercialMouvementStock { get; set; }

        public  ICollection<PivotDocumentCommercialDetail> DocumentCommercialDocumentCommercialDetail { get; set; }
